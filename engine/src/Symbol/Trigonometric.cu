...
namespace Sym {
    ...
    DEFINE_SIMPLE_ONE_ARGUMETN_OP_ARE_EQUAL(Sine)
    ...
    DEFINE_SIMPLE_ONE_ARGUMETN_OP_ARE_EQUAL(Cosine)
    ...
    DEFINE_SIMPLE_ONE_ARGUMETN_OP_ARE_EQUAL(Tangent)
    ...
    DEFINE_SIMPLE_ONE_ARGUMETN_OP_ARE_EQUAL(Cotangent)
