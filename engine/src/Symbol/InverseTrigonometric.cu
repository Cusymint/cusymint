...
namespace Sym {
    ...
    DEFINE_SIMPLE_ONE_ARGUMETN_OP_ARE_EQUAL(Arcsine)
    ...
    DEFINE_SIMPLE_ONE_ARGUMETN_OP_ARE_EQUAL(Arccosine)
    ...
    DEFINE_SIMPLE_ONE_ARGUMETN_OP_ARE_EQUAL(Arctangent)
    ...
    DEFINE_SIMPLE_ONE_ARGUMETN_OP_ARE_EQUAL(Arccotangent)
