...
namespace Sym {
    ...
    DEFINE_SIMPLIFY_IN_PLACE(Arcsine) {
    ...
    DEFINE_SIMPLIFY_IN_PLACE(Arccosine) {
        arg().simplify_in_place(help_space);
    }
    ...
    DEFINE_SIMPLIFY_IN_PLACE(Arctangent) {
        arg().simplify_in_place(help_space);
    }
    ...
    DEFINE_SIMPLIFY_IN_PLACE(Arccotangent) {
        arg().simplify_in_place(help_space);
    }

    std::string Arcsine::to_string() const {
        return "arcsin(" + arg().to_string() + ")";
    }

    std::string Arccosine::to_string() const {
        return "arccos(" + arg().to_string() + ")";
    }

    std::string Arctangent::to_string() const {
        return "arctan(" + arg().to_string() + ")";
    }

    std::string Arccotangent::to_string() const {
        return "arccot(" + arg().to_string() + ")";
    }

    template <class T>
    std::vector<Symbol> make_inverse_trigonometric_function(const T symbol, const std::vector<Symbol> &arg) {
